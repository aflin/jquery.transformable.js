/******************************************************************************
	jquery.transformable.js v0.3.5 copyright 2017 Aaron Flin (aaron at flin dot org).
		- 4 year hiatus.  There's a bit of a learning curve (again).
		- quick update to make it work with jquery 2.2.4 and jquery-ui 1.12.1
		- removed code related to msie 8
		- todo:  A thorough check of all code
		         Containment still needs work
		         Skew handle and skew amount need to be put in sync
